...
$jstag = getDynamicScriptAndLinkTags(array('type' => "plugin",'name' => 'transliterate','ext' => 'js'));
if (empty($_GET['action'])) {
	...
	<head>
		...
		<link type="text/css" rel="stylesheet" media="all" href="../../css.php?type=plugin&name=transliterate&cc_layout=$cc_layout" />
...
$jstag = getDynamicScriptAndLinkTags(array('type' => "plugin",'name' => 'transliterate','ext' => 'js'));
$csstag = getDynamicScriptAndLinkTags(array('type' => "plugin",'name' => 'transliterate','layout' => $cc_layout,'ext' => 'css'));
	echo <<<EOD
	<!DOCTYPE html>
	<html>
	<head>
