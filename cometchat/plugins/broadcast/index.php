...
if(CROSS_DOMAIN==1){
	...
	$cssurl = $server_name.BASE_URL.'css.php?cc_layout='.$cc_layout;
}
...
$csstag1 = getDynamicScriptAndLinkTags(array('type' => "plugin",'name' => 'broadcast','subtype' => 'webrtc','ext' => 'css'));
$csstag2 = getDynamicScriptAndLinkTags(array('layout' => $cc_layout,'ext' => 'css'));
$jstag = getDynamicScriptAndLinkTags(array('type' => "plugin",'name' => 'broadcast','subtype' => 'webrtc','ext' => 'js'));
echo <<<EOD
<!DOCTYPE html>
<html>
	<head>
