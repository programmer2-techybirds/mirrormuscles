...
WITH upsert AS (UPDATE cometchat_settings SET value = '23', key_type = '1' WHERE setting_key = 'dbversion' RETURNING *) INSERT INTO cometchat_settings (setting_key , value, key_type) SELECT 'dbversion', '23', '1' WHERE NOT EXISTS (SELECT * FROM upsert);
EOD;
