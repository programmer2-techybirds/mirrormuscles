...
if(!empty($_REQUEST['admin'])){
	...
	$jsfile = dirname(__FILE__).DIRECTORY_SEPARATOR.'writable'.DIRECTORY_SEPARATOR.$writable.DIRECTORY_SEPARATOR.$cbfn.$type.$name.$layout.$color.$lang.$enablecustomjs.'.js';
	$cometchat = array();
