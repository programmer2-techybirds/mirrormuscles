        ...
        return {
            ...
            initialize: function(){
                ...
                if($(document).width() <= 414 ){
                    headericon = '<div id = "cometchat_smallmenu"><img src="themes/<?php echo $theme;?>/images/menu.svg" height="24" width="24" class="smallmenuimages"/></div>';
                }else{
                    headericon = newcompose+moreoption+notificationicon;
                }
                if(settings.ccauth.enabled=="1" || jqcc.cometchat.getCcvariable().callbackfn=='desktop'){
                    auth_logout = '<div id = "cometchat_authlogout" style="padding-top: 2px;"><div id="cometchat_logout_icon" class="cometchat_logoutimages" title="'+language[80]+'"></div></div>';
                }
                ...
                var botstab = '';
                var bots = '';
                /*var recentgroup = '<div id="recentgroup" ><div id="cometchat_activechatboxes_popup" ></div><div class="cometchat_recentgroup"></div></div>';*/

                var chats = '<div id="chats" class="tabcontent" style="display:block;"><div id="cometchat_userslist" class="tabcontent"></div></div>';
                var group = '<div id="groups" ><div id="cometchat_chatroomstab_popup"></div></div>';
                usertabpop = '<div id="cometchat_popup_container"></div>';
                if(settings.showOnlineTab==1 && settings.enableType!=1){
                    /*UNCOMMENT FOR RECENT TAB*/
                    /*usertab = '<div id = "cometchat_recent"><span id="cometchat_recenttab" class="cometchat_tab tab_click" style="font-family:Lucida Grande/Tahoma;width: 33%;right: 0;" ><span class="cometchat_tabstext">Recent</span></span></div><div id = "cometchat_chats"><span id="cometchat_chatstab" class="cometchat_tab " style="font-family:Lucida Grande/Tahoma;width: 33%;right: 0;" ><span class="cometchat_tabstext">Chats</span></span></div><div id = "cometchat_groups"><span id="cometchat_groupstab" class="cometchat_tab " style="font-family:Lucida Grande/Tahoma;width: 34%;right: 0;" ><span class="cometchat_tabstext">Groups</span></span></div>';*/
                    if(settings.usebots == 1) {
                        bots = '<div id="bots" class="tabcontent" style="display:none;"><div id="cometchat_botslist"></div></div>';
                        /*botstab = '<div id = "cometchat_bots"><span id="cometchat_botstab"><span class="cometchat_tabstext"><div id="cometchat_botsicon" class="cometchat_tabicons"></div></span></span></div>';*/
                        botstab = '<div id = "cometchat_bots"><span id="cometchat_botstab" class="cometchat_tab"><span class="cometchat_tabstext"><div class="cometchat_bottabicon">'+botoutline+'</div></span></span></div>';
                    }

                    usertab = '<div id = "cometchat_chats" ><span id="cometchat_chatstab" class="cometchat_tab tab_click" style="font-family:Lucida Grande/Tahoma;right: 0;" ><span class="cometchat_tabstext">'+language["contacts"]+'</span></span></div>';
                    grouptab = '<div id = "cometchat_groups" ><span id="cometchat_groupstab" class="cometchat_tab " style="font-family:Lucida Grande/Tahoma;right: 0;" ><span class="cometchat_tabstext">'+language["groups"]+'</span></span></div>';
                ...
                if(chatroomsonly == 1){
                    ...
                    tabscontainer = usertab+grouptab+botstab;
                }
                ...
                if((hasChatroom != 1  || settings.enableType != 0) && chatroomsonly != 1){
                    tabscontainer = '';
                    searchbar = '';
                ...
                usertabpop = '<div id="cometchat_leftbar">'+tabscontainer+searchbar+'<div id="cometchat_userscontent"><div id="cc_gotoPrevNoti"></div><div id="cc_gotoNextNoti"></div>'+chats+group+bots+'</div></div>'+chatbox;
                var createChatroom = '';
                if(jqcc.cometchat.getChatroomVars("allowUsers") == 1){
                ...
                var tabcount = $('.cometchat_tab').length;
                var leftbarwidth = $('#cometchat_leftbar').width();
                if(tabcount != 0 && leftbarwidth != null) {
                    var tabswidth = (leftbarwidth/tabcount);
                    tabWidth = 'width: '+tabswidth+ 'px';
                    if(settings.usebots == 1){
                        tabWidth = 'width: 129px';
                    }
                    $('.cometchat_tab').attr("style",tabWidth);
                }
                if(hasChatroom == 1){
                ...
                $('#cometchat_header').on('click','#cometchat_smallmenu', function(e){
                    if(!$('#cometchat_smallmenu').hasClass('rotated')){
                        ...
                        var list = [language['more'],language['new_group']];
                        if(trayicon.broadcastmessage){
                ...
                $('#main_container').on('click','.cometchat_pluginrightarrow', function(e){
                    ...
                    if(!$('#'+this.id).hasClass('rotated')){
                        ...
                        jqcc[settings.theme].downWindow();
                        if(rtl == 1){
                            rotation = 270;
                        }else{
                            rotation = 90;
                ...
                $('#main_container').on('click','.cometchat_pluginuparrow', function(e){
                    ...
                    var rotation;
                    var plugin_userid = id[2];
                    var upPluginList = ['stickers','handwrite','screenshare','whiteboard','writeboard','broadcast','transliterate'];
                    if($(window).width() < 300 ){
                    ...
                    if( $('#cometchat_container_smilies').length <= 0 && $('#cometchat_container_stickers').length <= 0 && $('#cometchat_container_transliterate').length <= 0){
                        if(!$('#'+this.id).hasClass('rotated')){
                            $('#'+this.id).addClass('rotated');
                            rotation = 180;
                            var offset = $(this).offset();
                ...
                $('#cometchat_chatstab').click(function(){
                    ...
                    $('#cometchat_groupstab').removeClass('tab_click');
                    $('#cometchat_botstab').removeClass('tab_click');
                    $('#cometchat_chatstab').addClass('tab_click');
                    if(settings.usebots == 1) {
                        jqcc.ccembedded.bot_glyph();
                    }
                ...
                $('#cometchat_groupstab').click(function(){
                    ...
                    if(settings.usebots == 1) {
                        jqcc.ccembedded.bot_glyph();
                        /*$('#cometchat_groupstab').css("border-right","1px solid #D1D1D1");*/
                    }
                    jqcc.cometchat.setSessionVariable('openedtab',2);
                });

                $('#cometchat_botstab').click(function(e){
                    var botWidth = 'width: 40px';
                    $('#cometchat_user_search').val('');
                    $('#cometchat').find('#cometchat_user_search').keyup();
                    $('#bots').show();
                    $('#recentgroup').hide();
                    ...
                    $('#cometchat_groupstab').removeClass('tab_click');
                    $('#cometchat_recenttab').removeClass('tab_click');
                    $('#cometchat_botstab').addClass('tab_click');
                    /*$('#cometchat_groupstab').css("border-left","1px solid #D1D1D1");
                    $('#cometchat_groupstab').css("border-right","1px solid #D1D1D1");*/
                    if(settings.usebots == 1) {
                        jqcc.ccembedded.bot_outline();
                    }
                    $('#cometchat_chatroomstab_popup').removeClass("cometchat_tabopen");
                    $('#cometchat_userstab_popup').removeClass("cometchat_tabopen");
                    jqcc.cometchat.setSessionVariable('openedtab',3);
                    //jqcc('#cometchat_groupstab').css({'border-right':'none','border-left':'1px solid #E6E7EA'});
                ...
                $('.cometchat_module').click(function(){
                    ...
                    if(id[2] == 'block'){
                        ...
                        var content = '<iframe src="'+baseUrl+'modules/'+id[2]+'/index.php?cc_theme=embedded&basedata=null" frameborder="0" height="'+height+'" id="cometchat_'+id[2]+'"></iframe>';
                ...
                $('#cometchat_header').on('click','#cometchat_notification',function(){
                    ...
                    var announcementcontent = '<iframe src="'+baseUrl+'modules/announcements/index.php?cc_theme=embedded&basedata=null" frameborder="0" style="height:calc(100% - 48px);"></iframe>';
                ...
                $( '#cometchat_header' ).on( 'click', '.float_list', function () {
                    ...
                    switch(id[2]){
                        ...
                        case language[113].replace(/\s+/, ""):
                            ...
                            $('.cometchat_float_list').hide();
                            var content = '<iframe style="border-top:1px solid #D1D1D1;height:100%;" frameborder="0" width="300" src="'+baseUrl+'modules/broadcastmessage/index.php?cc_theme=embedded&id=1&basedata='+jqcc.cometchat.getBaseData()+'"></iframe>';
                ...
                if($("#cometchat_botstab").length != -1){
                    $("#cometchat_botstab").hover(
                     function(){
                            jqcc.ccembedded.bot_outline();
                    },
                    function(){
                        if($("#cometchat_botstab").hasClass('tab_click')){
                            jqcc.ccembedded.bot_outline();
                        }else{
                            jqcc.ccembedded.bot_glyph();
                        }
            ...
            bot_outline: function(){
                    $(".cometchat_bottabicon").html(botglyph);
            },
            bot_glyph: function(){
                    $(".cometchat_bottabicon").html(botoutline);
            },
            /*//////////////////////////////////functions/////////////////////////////////*/
            ...
            downWindow: function(){
                if($('.cometchat_container').length > 0){
                    ...
                    cometchat_container.each(function(){
                        ...
                        id = divid.split("_");
                        if(id[2] == 'smilies' || id[2] == 'stickers' || id[2] == 'transliterate'){
            ...
            create_side_window: function(id,title,content){
                var sidewindow = '<div id="'+id+'_window" class="cometchat_windows"><div id="cometchat_windowtitlebar">'+title+'<div id="'+id+'_closewindow" class="cometchat_closewindow" ><img src="themes/<?php echo $theme;?>/images/removewhite.svg"/></div></div><div id="'+id+'_container" class="cometchat_side_container">'+content+'</div></div>';
                return sidewindow;
            },
            ...
            buddyList: function(item){
                ...
                $.each(item, function(i, buddy){
                    ...
                    var msgcounter = '';
                    if(jqcc.cometchat.getThemeVariable('openChatboxId')!=buddy.id && typeof(jqcc.cometchat.getThemeArray('buddylistUnreadMessageCount', buddy.id)) != "undefined" && jqcc.cometchat.getThemeArray('buddylistUnreadMessageCount', buddy.id) != '') {
                        unreadmessagecount = jqcc.cometchat.getThemeArray('buddylistUnreadMessageCount', buddy.id);
                        if(unreadmessagecount){
                            msgcounter = '<span class="cometchat_msgcount"><div class="cometchat_msgcounttext">'+unreadmessagecount+'</div></span>';
                        }
                    }

                    if((buddy.s != 'offline' && settings.hideOffline == 1) || settings.hideOffline == 0){
                        buddylisttemp += group+'<div id="cometchat_userlist_'+buddy.id+'" class="cometchat_userlist" onmouseover="jqcc(this).addClass(\'cometchat_userlist_hover\');" onmouseout="jqcc(this).removeClass(\'cometchat_userlist_hover\');"><span class="cometchat_userscontentavatar">'+overlay_div+'<img class="cometchat_userscontentavatarimage" src="themes/'+settings.theme+'/images/cometchat_'+buddy.s+'.png"></span><div class="cometchat_chatboxDisplayDetails"><div class="cometchat_userdisplayname">'+longname+'</div><span id="cometchat_buddylist_typing_'+buddy.id+'" class="cometchat_buddylist_typing"></span><span class="cometchat_userscontentdot cometchat_'+usercontentstatus+'">'+icon+'</span><div class="cometchat_userdisplaystatus">'+buddy.m+'</div></div>'+msgcounter+'</div>';
            ...
            loggedOut: function(){
                ...
                if(settings.ccauth.enabled=="1" && !mobileDevice){
                    ...
                    authactive.forEach(function(auth) {
                        ccauthpopup += '<div  class="auth_options '+auth.toLowerCase()+'_auth_options" onclick="window.open(\''+baseUrl+'functions/login/signin.php?network='+auth.toLowerCase()+'\',\'socialwindow\')" ><img src="'+baseUrl+'themes/embedded/images/login'+auth.toLowerCase()+'.svg"><span>'+auth.toLowerCase()+'</span></div>';
                    });
            ...
            typingTo: function(item){
                if(typeof item['fromid'] != 'undefined'){
                    ...
                    var msg = jqcc[settings.theme].processMessage('<div id="cometchat_istyping_'+id+'" class="cometchat_messagebox"><div  class="cometchat_chatboxmessage"><span class="cometchat_chatboxmessagecontent">'+notify_typing+'</span>'+fromavatar+'</div></div><div style="clear:both"></div>', '');
            ...
            deliveredReadMessageNotify: function(item){
               if($("#cometchat_message_"+item['message']).length == 0){
                ...
                } else if(typeof item['fromid'] != 'undefined' && $("#cometchat_chatboxseen_"+item['message']).parent().hasClass('cometchat_messagebox_self') && jqcc.cometchat.getExternalVariable('messagereceiptsetting') == 0){
            ...
            if(settings.enableType!=1 && embeddedchatroomid==0){
                ...
                if(typeof(cometchat_user_popup)=='undefined' || cometchat_user_popup.length<1){
                        ...
                        if(pluginslength>0){
                            for(var i = 0; i<pluginslength; i++){
                                ...
                                if(settings.plugins[i] == 'audiochat'){
                                    ...
                                    smilieshtml = '<div id="smileyicon" class="ccplugins cometchat_smilies" title="'+$[name].getTitle()+'" name="'+name+'" to="'+id+'" chatroommode="0" ><img src="themes/<?php echo $theme;?>/images/smileyicon.svg"></div>';
                                }else if(settings.plugins[i]=='filetransfer'){
                                    filetransferhtml='<img src="'+baseUrl+'themes/'+settings.theme+'/images/attach.svg" class="ccplugins" title="'+$[name].getTitle()+'" name="'+name+'" to="'+id+'" chatroommode="0"/>';
                                }else if(settings.plugins[i]=='voicenote'){
                                    /*voicenotehtml='<img src="'+baseUrl+'themes/'+settings.theme+'/images/recorder.svg" class="ccplugins" title="'+$[name].getTitle()+'" name="'+name+'" to="'+id+'" chatroommode="0"/>';*/
                                }
                            }
                        }
                    }
                    var plugin_divider = '<div id="vline"><img src="themes/<?php echo $theme;?>/images/vline.svg"/ style="margin-top:12px;"></div>';
                    if (audiochat == '' && avchathtml == '') {
                        plugin_divider = '';
                    }
                    headerplugin = headerplugin+avchathtml+audiochat+plugin_divider+'<div  class="cometchat_user_closebox"><img src="themes/<?php echo $theme;?>/images/remove.svg"/></div></div>';
                    var startlink = '';
                    var endlink = '';
                    if(link!=''){
                    ...
                    $("<div/>").attr("id", "cometchat_user_"+id+"_popup").addClass("cometchat_userchatbox").addClass("cometchat_tabpopup cometchat_"+tabstateclass).html('<div class="cometchat_userchatarea"><div class="cometchat_tabsubtitle"><div class="cometchat_chatboxLeftDetails">'+avatarsrc+'<div class="cometchat_chatboxDisplayDetails"><div style="position: absolute;margin-left: 20px;" title="'+longname+'"><div class="cometchat_username">'+longname+'</div><span id="cometchat_typing_'+id+'" class="cometchat_typing"></span><div id="cometchat_pluginrightarrow_'+id+'" class="cometchat_pluginrightarrow"></div><div style="margin:0px;padding:0px;" class="cometchat_userdisplaystatus" title="'+message+'">'+message+'</div></div></div></div>'+headerplugin+'</div><div class="cometchat_prependMessages_container"></div><div class="cometchat_tabcontent"><div class="cometchat_tabcontenttext" id="cometchat_tabcontenttext_'+id+'" onscroll="jqcc.'+settings.theme+'.chatScroll(\''+id+'\');"><div class="cometchat_message_container">'+prepend+'</div></div><div id="cometchat_tabinputcontainer"><div id="downplugins"><div id="cometchat_pluginuparrow_'+id+'" class="cometchat_pluginuparrow"><img class="cometchat_pluginuparrowimage" src="themes/'+settings.theme+'/images/circledown.svg"/></div><textarea id="cometchat_textarea_'+id+'" class="cometchat_textarea" placeholder="'+language[85]+'"></textarea>'+smilieshtml+'<div id="cometchat_attachements">'+filetransferhtml+'</div></div></div>'+selectlang+'</div></div></div>').appendTo($("#cometchat_righttab"));
                    ...
                    cometchat_user_popup.find("textarea.cometchat_textarea").focus(function(event){
                        setTimeout(function(){
                            ...
                            if(mobileDevice && textvalue != ''){
                                var sendicon = '<div id="cometchat_send"><img src="'+baseUrl+'themes/'+settings.theme+'/images/send.svg" class="cometchat_tabcontentsubmit" /></div>';
                                $('#cometchat_user_'+id+'_popup').find('#cometchat_attachements').replaceWith(sendicon);
                            }else if(mobileDevice && textvalue == ''){
                                var attachicon = '<div id="cometchat_attachements"><img src="'+baseUrl+'themes/'+settings.theme+'/images/attach.svg" class="ccplugins" title="'+$['ccfiletransfer'].getTitle()+'" name="ccfiletransfer" to="'+id+'" chatroommode="0"/></div>';
                    ...
                    cometchat_user_popup.find("div#cometchat_tabinputcontainer").on('click','.cometchat_tabcontentsubmit',function(event){
                    ...
                    cometchat_user_popup.on('click','.ccplugins',function(event){
                        ...
                        if(name != 'ccstickers' && name != 'cctransliterate' && name != 'ccsmilies') {
                            $('.cometchat_pluginuparrow').removeClass('rotated').css({'transform' :'rotate(0deg)'});
                        }
                    });
                    ...
                    cometchat_user_popup.find('div.cometchat_user_closebox').click(function(){
                        ...
                        if(closeflag){
                            ...
                            if(chatBoxOrder == ''){
                                jqcc.cometchat.setThemeVariable('openChatboxId',0);
                            }else{
                            ...
                            if(nextChatBox) {
                                if(!isNaN(nextChatBox) && nextChatBox.charAt(0) != '_') {
                                    ...
                                    jqcc.cometchat.getChatroomDetails(nextChatBox,1);
                                }
                            }
                            $('.cometchat_noactivity').css('display','block');
                            jqcc[settings.theme].activeChatBoxes();
                ...
                if(jqcc.cometchat.getThemeVariable('openChatboxId')==id&&jqcc.cometchat.getThemeVariable('trayOpen')!='chatrooms'){
                    ...
                    if(openedChatbox = jqcc.cometchat.getThemeVariable('openedChatbox')) {
                    ...
                    cometchat_user_popup.addClass('cometchat_tabopen').removeClass('cometchat_hidden');
                ...
                $.each(item, function(i, incoming){
                    ...
                    if(jqcc.cometchat.getThemeArray('buddylistName', incoming.from)==null||jqcc.cometchat.getThemeArray('buddylistName', incoming.from)==''){
                        ...
                        if($("#cometchat_message_"+incoming.id).length>0){
                            ...
                            var msg = jqcc[settings.theme].processMessage('<div class="cometchat_time cometchat_time_'+msg_date_class+' '+date_class+'" msg_format="'+msg_date_format+'">'+msg_date+'</div><div class="cometchat_messagebox '+selfmessage+'"><div class="'+add_bg+'" id="cometchat_message_'+incoming.id+'"><span class="cometchat_chatboxmessagecontent" style="'+imagemsg_rightcss+'">'+message+'</span>'+fromavatar+'</div><span id="cometchat_chatboxseen_'+incoming.id+'"></span>'+sentdata+'</div></div><div style="clear:both"></div>', selfstyle);
                        ...
                        if(jqcc.cometchat.getThemeVariable('openChatboxId') != incoming.from && incoming.self != 1 && incoming.old != 1 && ((typeof(alreadyreceivedunreadmessages[incoming.from])!='undefined'&& alreadyreceivedunreadmessages[incoming.from]<incoming.id) || typeof(alreadyreceivedunreadmessages[incoming.from])=='undefined')){
                    ...
                    if(settings.cometserviceEnabled == 1 && settings.messagereceiptEnabled == 1 && jqcc.cometchat.getCcvariable().callbackfn != "mobilewebapp" && (settings.transport == 'cometservice' || settings.transport == 'cometservice-selfhosted')  && incoming.old == 0 && incoming.self == 1 && incoming.direction == 0){
            ...
            textboxresize: function(chattextarea,cometchat_user_popup,id){
                ...
                if ($(chattextarea).innerHeight < chattextarea.scrollHeight ) {
                    ...
                    jqcc[settings.theme].windowResize();
                    if($('#cometchat_container_smilies').length == 1 || $('#cometchat_container_stickers').length == 1 || $('#cometchat_container_transliterate').length == 1){
            ...
            addPopup: function(id, amount, add){
                ...
                if(jqcc.cometchat.getThemeArray('buddylistName', id)==null||jqcc.cometchat.getThemeArray('buddylistName', id)==''){
                    ...
                    if(cometchat_msgcount.length > 0 && add == 1){
                        amount = parseInt(cometchat_user_id.find(".cometchat_msgcounttext").text())+parseInt(amount);
                        if((typeof $.cookie(settings.cookiePrefix+"sound") == 'undefined' || $.cookie(settings.cookiePrefix+"sound") == null) || $.cookie(settings.cookiePrefix+"sound")=='true'){
                    ...
                    if(amount==0 && add==0){
                        ...
                        var msgcount = parseInt(cometchat_msgcount.find(".cometchat_msgcounttext").text());
                        if(cometchat_msgcount.length>0){
                            cometchat_msgcount.find(".cometchat_msgcounttext").text(msgcount+1);
                        }else{
            ...
            chatTab: function(){
                ...
                cometchat_user_search.keyup(function(){
                    ...
                    if($('#cometchat_leftbar').find('#cometchat_groupstab').hasClass('tab_click')){
                    ...
                    if($('#cometchat_leftbar').find('#cometchat_botstab').hasClass('tab_click')){
                        bots_list = $('#cometchat_botslist');
                        $(document).find('.cc_nousers').remove();
                        if(searchString.length>0 && searchString!='Search'){
                            $('#cometchat').find('#close_user_search').css('display','block');
                            bots_list.find('div.cometchat_botlist').hide();
                            var count = bots_list.find('div.cometchat_botdisplayname:icontains('+searchString+')');
                            if(count['length'] >= 1){
                                bots_list.find('div.cometchat_botdisplayname:icontains('+searchString+')').parents('div.cometchat_botlist').show();
                                bots_list.find('.cometchat_nobots_found').remove();
                            }else{
                                if($(document).find('.cometchat_nobots_found').length == 0){
                                    bots_list.append('<div class="cometchat_nobots_found" style="padding-top: 8px; text-align:center; display: block; color: #4A4848; ">'+language[118]+'</div>');
                                }else if($(document).find('.cometchat_nobots_found').css("display") == "none") {
                                    $(document).find('.cometchat_nobots_found').show();
                                    $(document).find('.cc_nousers').remove();
                                }
                            }
                            cometchat_user_search.removeClass('cometchat_search_light');
                            ...
                            $('#cometchat').find('#close_user_search').css('display','none');
                            bots_list.find('div.cometchat_botlist').show();
                            bots_list.find('.cometchat_nobots_found').hide();
                        }
                    }
            ...
            optionsButton: function(){
                ...
                cometchat_optionsbutton_popup.find("#cometchat_selfdisplayname").blur(function(){
                ...
                function logout_click(){
                    $('#cometchat_header').on('click','#cometchat_authlogout',function(){
                ...
                if(jqcc.cometchat.getThemeVariable('loggedout') == 0){
                    if(params != null){
                        $.each(params, function(index, item){
                            if(item['g']) {
                                if(item.hasOwnProperty('s') && item['s'] == 1) {
                                    var chatroomDetails = jqcc.cometchat.getChatroomDetails(item['id']);
                                    if(chatroomDetails != ''){
                                    ...
                                    jqcc.crembedded.addMessageCounter(item.id,item.c,0);
                                }
                            }else {
                                if(item.hasOwnProperty('s') && typeof (jqcc[settings.theme].createChatboxData)!=='undefined' && typeof(item['id'] != "undefined")){
                                    if(item['s'] > 0){
                                        jqcc[settings.theme].createChatboxData(item['id'], jqcc.cometchat.getThemeArray('buddylistName', item['id']), jqcc.cometchat.getThemeArray('buddylistStatus', item['id']), jqcc.cometchat.getThemeArray('buddylistMessage', item['id']), jqcc.cometchat.getThemeArray('buddylistAvatar', item['id']), jqcc.cometchat.getThemeArray('buddylistLink', item['id']), jqcc.cometchat.getThemeArray('buddylistIsDevice', item['id']), item['s'], null);
                                    }
                                }
                                if(item.hasOwnProperty('c') && item['c']>0) {
                                    jqcc[settings.theme].addPopup(item['id'],item['c'],0);
                                }
                            }
                        });
                    }
            ...
            windowResize: function(silent){
                if(settings.enableType == 1 && chatroomsonly != 1){
                    ...
                    var leftbarwidth = $('#cometchat_leftbar').width();
                    if(settings.usebots == 1){
                        leftbarwidth = leftbarwidth -42;
                    }
                    if(tabcount != 0 && leftbarwidth != null) {
                        var tabswidth = (leftbarwidth/2);
                        tabWidth = 'width: '+tabswidth+ 'px';
                        $("#cometchat_chats").find('.cometchat_tab').attr("style",tabWidth);
                        $("#cometchat_groups").find('.cometchat_tab').attr("style",tabWidth);
                    }
                }
            },
                    ...
                    if(type=="messages"){
                        $.each(item, function(i, incoming){
                           ...
                           if(incoming.sent!=null){
                            ...
                            var msg = jqcc[settings.theme].processMessage('<div class="cometchat_time cometchat_time_'+msg_date_class+' '+date_class+'" msg_format="'+msg_date_format+'">'+msg_date+'</div><div class="cometchat_messagebox '+selfmessage+'"><div class="'+add_bg+'" id="cometchat_message_'+incoming.id+'"><span class="cometchat_chatboxmessagecontent" style="'+imagemsg_rightcss+'">'+message+'</span>'+fromavatar+'</div><span id="cometchat_chatboxseen_'+incoming.id+'"></span>'+sentdata+'</div><div style="clear:both"></div>', selfstyle);
                            oldMessages+=msg;
                        });
                    }
                });
