...
${$addonname.'_language'}['joining_chatroom'] = setLanguageValue('joining_chatroom','Joining chatroom...',$lang,$addontype,$addonname);
...
${$addonname.'_language'}['err_creating_cr'] = setLanguageValue('err_creating_cr','Error while creating chatroom',$lang,$addontype,$addonname);
...
${$addonname.'_language'}['n_users_available'] = setLanguageValue('n_users_available','No users available in this chatroom',$lang,$addontype,$addonname);
...
${$addonname.'_language'}['rename_chatroom'] = setLanguageValue('rename_chatroom','Rename chatroom',$lang,$addontype,$addonname);
${$addonname.'_language'}['chatroom_name'] = setLanguageValue('chatroom_name','Chatroom name',$lang,$addontype,$addonname);
${$addonname.'_language'}['renaming'] = setLanguageValue('renaming','Renaming Chatroom',$lang,$addontype,$addonname);
