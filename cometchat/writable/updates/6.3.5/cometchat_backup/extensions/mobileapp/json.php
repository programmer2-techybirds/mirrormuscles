...
$response_lang = Array();
$supported_plugins = array('clearconversation', 'style', 'report', 'avchat', 'filetransfer','block','audiochat','whiteboard', 'broadcast', 'handwrite', 'writeboard');
...
$response['mobile_theme']['login_button_pressed']= $response['mobile_theme']['login_button'] = $primary_color;
...
if(!empty($response['chatroomsmodule_enabled'])){
...
$response['mobile_theme']['actionbar_color']= $themeSettings['tab_title_background'] = $primary_color;
$response['mobile_theme']['actionbar_text_color']= $actionbar_text_color;
$response['mobile_theme']['primary_color']= $primary_color;
$response['mobile_theme']['secondary_color']= $secondary_color;
...
$response['mobile_theme']['right_bubble_color']= $primary_color;
