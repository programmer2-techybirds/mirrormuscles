...
if(!empty($_REQUEST['admin'])){
	$adminjs = dirname(__FILE__).DIRECTORY_SEPARATOR.'writable'.DIRECTORY_SEPARATOR.$writable.DIRECTORY_SEPARATOR.'admin.js';
	if(file_exists($adminjs)&&DEV_MODE!=1){
		if (@strtotime($_SERVER['HTTP_IF_MODIFIED_SINCE']) == filemtime($adminjs) ||
			@trim($_SERVER['HTTP_IF_NONE_MATCH']) == md5_file($adminjs)) {
		...
		include_once(dirname(__FILE__).DIRECTORY_SEPARATOR."admin".DIRECTORY_SEPARATOR."js".DIRECTORY_SEPARATOR."tooltip.js");
	...
	$jsfile = dirname(__FILE__).DIRECTORY_SEPARATOR.'writable'.DIRECTORY_SEPARATOR.$writable.DIRECTORY_SEPARATOR.$cbfn.$type.$name.$theme.$color.$lang.'.js';
	$cometchat = array();
	if(file_exists($jsfile)&&DEV_MODE!=1){
		if (@strtotime($_SERVER['HTTP_IF_MODIFIED_SINCE']) == filemtime($jsfile) ||
			@trim($_SERVER['HTTP_IF_NONE_MATCH']) == md5_file($jsfile)) {
			header("HTTP/1.1 304 Not Modified");
			exit;
		}
		readfile($jsfile);
		...
		if(($type!='core'||$name!='default')&&($type!='extension'||($type=='extension'&&$name=='jabber'))&&($type!='external')){
			if($type =='core' && $name=='embedcode'){
				...
				if(file_exists(dirname(__FILE__).DIRECTORY_SEPARATOR."integrations".DIRECTORY_SEPARATOR.$cms.'.js')&&empty($cbfn)){
					include_once(dirname(__FILE__).DIRECTORY_SEPARATOR.'integrations'.DIRECTORY_SEPARATOR.$cms.'.js');
				}
			}
			if($type=='core'){
			...
			if($theme=='synergy' && (!empty($cometchat['trayicon']['chatrooms']) || !empty($_REQUEST['chatroomid']) || !empty($_REQUEST['chatroomsonly']))){
				...
				if(!empty($_REQUEST['chatroomid']) || !empty($_REQUEST['chatroomsonly'])) {
					include_once(dirname(__FILE__).DIRECTORY_SEPARATOR."modules".DIRECTORY_SEPARATOR."chatrooms".DIRECTORY_SEPARATOR."themes".DIRECTORY_SEPARATOR."synergy".DIRECTORY_SEPARATOR."js".DIRECTORY_SEPARATOR."synergy.js");
				}
			}
			if($theme=='embedded' && (!empty($cometchat['trayicon']['chatrooms']) || !empty($_REQUEST['chatroomid']) || !empty($_REQUEST['chatroomsonly']))){
				include_once(dirname(__FILE__).DIRECTORY_SEPARATOR."modules".DIRECTORY_SEPARATOR."chatrooms".DIRECTORY_SEPARATOR."js".DIRECTORY_SEPARATOR."chatrooms.js");
				if(!empty($_REQUEST['chatroomid']) || !empty($_REQUEST['chatroomsonly'])) {
					include_once(dirname(__FILE__).DIRECTORY_SEPARATOR."modules".DIRECTORY_SEPARATOR."chatrooms".DIRECTORY_SEPARATOR."themes".DIRECTORY_SEPARATOR."embedded".DIRECTORY_SEPARATOR."js".DIRECTORY_SEPARATOR."embedded.js");
				}
			}
			if($theme=='synergy' && empty($cometchat['trayicon']['chatrooms'])){
				...
				if(file_exists(dirname(__FILE__).DIRECTORY_SEPARATOR."modules".DIRECTORY_SEPARATOR."chatrooms".DIRECTORY_SEPARATOR."themes".DIRECTORY_SEPARATOR."synergy".DIRECTORY_SEPARATOR."js".DIRECTORY_SEPARATOR."synergy.js")){
					include_once(dirname(__FILE__).DIRECTORY_SEPARATOR."modules".DIRECTORY_SEPARATOR."chatrooms".DIRECTORY_SEPARATOR."themes".DIRECTORY_SEPARATOR."synergy".DIRECTORY_SEPARATOR."js".DIRECTORY_SEPARATOR."synergy.js");
				}
			} else if($theme=='embedded' && !empty($cometchat['trayicon']['chatrooms'])){
				if(file_exists(dirname(__FILE__).DIRECTORY_SEPARATOR."modules".DIRECTORY_SEPARATOR."chatrooms".DIRECTORY_SEPARATOR."js".DIRECTORY_SEPARATOR."chatrooms.js")){
					include_once(dirname(__FILE__).DIRECTORY_SEPARATOR."modules".DIRECTORY_SEPARATOR."chatrooms".DIRECTORY_SEPARATOR."js".DIRECTORY_SEPARATOR."chatrooms.js");
				}
				if(file_exists(dirname(__FILE__).DIRECTORY_SEPARATOR."modules".DIRECTORY_SEPARATOR."chatrooms".DIRECTORY_SEPARATOR."themes".DIRECTORY_SEPARATOR."embedded".DIRECTORY_SEPARATOR."js".DIRECTORY_SEPARATOR."embedded.js")){
					include_once(dirname(__FILE__).DIRECTORY_SEPARATOR."modules".DIRECTORY_SEPARATOR."chatrooms".DIRECTORY_SEPARATOR."themes".DIRECTORY_SEPARATOR."embedded".DIRECTORY_SEPARATOR."js".DIRECTORY_SEPARATOR."embedded.js");
				}
			} else {
				if(file_exists(dirname(__FILE__).DIRECTORY_SEPARATOR."modules".DIRECTORY_SEPARATOR."chatrooms".DIRECTORY_SEPARATOR."js".DIRECTORY_SEPARATOR."chatrooms.js")){
				...
				if(file_exists(dirname(__FILE__).DIRECTORY_SEPARATOR."modules".DIRECTORY_SEPARATOR."chatrooms".DIRECTORY_SEPARATOR."themes".DIRECTORY_SEPARATOR."docked".DIRECTORY_SEPARATOR."js".DIRECTORY_SEPARATOR."docked.js")){
					include_once(dirname(__FILE__).DIRECTORY_SEPARATOR."modules".DIRECTORY_SEPARATOR."chatrooms".DIRECTORY_SEPARATOR."themes".DIRECTORY_SEPARATOR."docked".DIRECTORY_SEPARATOR."js".DIRECTORY_SEPARATOR."docked.js");
				}
			}
			if(empty($cbfn) || $cbfn=='desktop'){
				if(file_exists(dirname(__FILE__).DIRECTORY_SEPARATOR."themes".DIRECTORY_SEPARATOR.$theme.DIRECTORY_SEPARATOR."js".DIRECTORY_SEPARATOR.$theme.".js")){
					...
					include_once(dirname(__FILE__).DIRECTORY_SEPARATOR."themes".DIRECTORY_SEPARATOR.$theme.DIRECTORY_SEPARATOR."js".DIRECTORY_SEPARATOR."docked.js");
				}
			...
			foreach ($trayicon as $module => $moduleinfo){
				if(file_exists(dirname(__FILE__).DIRECTORY_SEPARATOR."modules".DIRECTORY_SEPARATOR.$module.DIRECTORY_SEPARATOR."extra.js")&&empty($cbfn)){
					include_once(dirname(__FILE__).DIRECTORY_SEPARATOR."modules".DIRECTORY_SEPARATOR.$module.DIRECTORY_SEPARATOR."extra.js");
				}
			}
			if(file_exists(dirname(__FILE__).DIRECTORY_SEPARATOR."integrations".DIRECTORY_SEPARATOR.$cms.'.js')&&empty($cbfn)&&empty($cc_theme)){
				include_once(dirname(__FILE__).DIRECTORY_SEPARATOR.'integrations'.DIRECTORY_SEPARATOR.$cms.'.js');
			}

			if(!empty($settings['enable_customjs']) && $settings['enable_customjs']['value'] == 1 && !empty($settings['customjs']) && empty($cbfn)){
				echo $settings['customjs']['value'];
			}

			if(file_exists(dirname(__FILE__).DIRECTORY_SEPARATOR.'js'.DIRECTORY_SEPARATOR.'svg.js')){
				include_once(dirname(__FILE__).DIRECTORY_SEPARATOR.'js'.DIRECTORY_SEPARATOR.'svg.js');
			}
		}
