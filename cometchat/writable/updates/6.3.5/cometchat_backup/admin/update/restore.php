...
if(!empty($_GET['backup'])){
	...
	file_put_contents(dirname(dirname(dirname(__FILE__))).DIRECTORY_SEPARATOR."integration.bak",$oldfile);
}else{
	$oldfile = file_get_contents(dirname(dirname(dirname(__FILE__))).DIRECTORY_SEPARATOR."integration.bak");
