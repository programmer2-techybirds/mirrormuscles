			...
			init: function (params) {
				...
				if(chatroommode == 1 && mobileDevice == null) {
					...
					if(theme == 'embedded'){
						...
						loadPopupInChatbox(baseUrl+'plugins/handwrite/index.php?chatroommode=1&id='+id+'&basedata='+baseData+'&sendername='+roomname, 'handwrite', 0, id, chatroommode);
					...
					if(theme == 'embedded'){
						...
						loadPopupInChatbox(baseUrl+'plugins/handwrite/index.php?id='+id+'&basedata='+baseData+'&sendername='+jqcc.cometchat.getName(jqcc.cometchat.getThemeVariable('userid')), 'handwrite', 0, id, 0);
