...
<div id="content" style="width:auto">
		...
		<div>
			...
			<div id="centernav" style="width:380px {$innercontent}">
				...
				<div class="title" style="padding: 4px;width: 237px !important">Use Google Translate API:<br>(If you want to use Bing API then select no)</br></div><div class="element"><input type="radio" name="useGoogle" value="1" $dy>Yes <input type="radio" $dn name="useGoogle" value="0" >No</div>
