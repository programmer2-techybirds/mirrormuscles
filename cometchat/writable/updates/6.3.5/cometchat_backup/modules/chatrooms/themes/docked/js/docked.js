    ...
    $.crdocked = (function() {
        return {
                ...
                createChatroomPopup:function(){
                    ...
                    var createchatroompopup = '<div id="cometchat_createchatroom_popup" class="cometchat_tabpopup cometchat_tabhidden"><div class="cometchat_userstabtitle"><div class="cometchat_userstabtitletext" style="width: 80%;text-align: center;"><?php echo $chatrooms_language[105];?></div><div class="cometchat_closebox cometchat_tooltip" id="cometchat_minimize_createchatroompopup" title="Close"></div></div><div id="cometchat_createchatroom_content" class="cometchat_tabcontent cometchat_optionstyle" style="overflow:hidden;">'+createChatroom+'</div></div>';
                ...
                addChatroomMessage: function(fromid,incomingmessage,incomingid,selfadded,sent,fromname,calledfromsend,chatroomid){
                    ...
                    if(message != '') {
                        ...
                        if($("#cometchat_groupmessage_"+incomingid).length > 0) {
                            ...
                            if(fromid != settings.myid) {
                                ...
                                var fromavatar = '<a class="cometchat_floatL" href="'+jqcc.cometchat.getThemeArray('buddylistLink', fromid)+'"><img class="ccmsg_avatar" src="'+jqcc.cometchat.getThemeArray('buddylistAvatar', fromid)+'" title="'+fromname+'"/></a>';
                    ...
                    if(jqcc.cometchat.getChatroomVars('owner')|| jqcc.cometchat.getChatroomVars('isModerator') || (jqcc.cometchat.getChatroomVars('allowDelete') == 1 && fromid == settings.myid)) {
                        ...
                        if(grouppopup.find("#cometchat_groupmessage_"+incomingid).find(".delete_msg").length < 1) {
                            ...
                            grouppopup.find('#cometchat_groupmessage_'+incomingid).find("."+cometchat_ts_class).after('<span class="delete_msg" style="'+cometchat_ts_style+';'+cometchat_del_style+';" onclick="javascript:jqcc.cometchat.confirmDelete(\''+incomingid+'\',\''+chatroomid+'\');"><img class="hoverbraces" src="'+baseUrl+'themes/docked/images/bin.svg"></span>');
                        }
                ...
                loadRoom: function(clicked,id,minimized,unreadmsgcount) {
                    ...
                    cometchat_group_popup.find('.cometchat_plugins_dropdown').click(function(e){
                        ...
                        if(jqcc().slimScroll){
                            ...
                            cometchat_group_popup.find('.cometchat_pluginstop').slimScroll({height: (cometchat_slimscroll_height)+'px'});
                    ...
                    cometchat_group_popup.find('.cometchat_plugins_openup').click(function(){
                        ...
                        if(mobileDevice){
                            ...
                            if(cometchat_group_popup.find('.cometchat_pluginsbottom').parent().hasClass('slimScrollDiv')){
                                ...
                                cometchat_group_popup.find('.cometchat_pluginsbottom').slimScroll({height: (cometchat_slimscroll_height+1)+'px'});
                            }
                            var bottompluginsbox_height =  cometchat_group_popup.find('.cometchat_tabcontent').outerHeight();
                            var cometchat_textarea_height = cometchat_group_popup.find('.cometchat_tabcontentinput').outerHeight(true);
                    ...
                    jqcc('#cometchat_sendmessagebtn').click(function(e){
                        ...
                        if(cometchat_group_popup.find('.cometchat_tabcontent .cometchat_chatboxpopup_'+roomno).length == 0){
                            ...
                            if(default_height!=0){
                                var embed = cometchat_group_popup.find('.cometchat_iframe').contents().find('.embed');
                                if(embed.length==1) {
                ...
                resizeCrinputTextarea: function(cometchat_group_popup,chatboxtextarea,id,event){
                    ...
                    if ($(chatboxtextarea).innerHeight < chatboxtextarea.scrollHeight ) {
                        ...
                        if(cometchat_group_popup.find('.cometchat_tabcontent .cometchat_chatboxpopup_'+id).length == 0){
                            cometchat_group_popup.find('.cometchat_tabcontenttext').height(285);
                           if($('#cometchat_grouptabcontenttext_'+id).parent().hasClass('slimScrollDiv') == true){
                                $('#cometchat_grouptabcontenttext_'+id).parent().height(285);
                            }
                            $[calleeAPI].chatroomScrollDown(forced,id);
                        }else{
                            var iframe_name = jqcc('.cometchat_iframe').attr('id');
                ...
                inviteGroupUsers: function(groupid,data) {
                    ...
                    if(jqcc.isEmptyObject(groupdetails)) {
                        jqcc.cometchat.getChatroomDetails(groupid,0,1,'inviteGroupUsers');
                    }else {
                ...
                unbanGroupUsers: function(groupid) {
                    var baseurl = jqcc.cometchat.getBaseUrl();
                    var basedata = jqcc.cometchat.getBaseData();
                    var groupdetails = jqcc.cometchat.getChatroomDetails(groupid,0,1);
                    var roompass = groupdetails.password;
                    var roomname = b2a(groupdetails.name);
                ...
                updateChatroomUsers: function(item,fetchedUsers) {
                    ...
                    $.each(item, function(i,user) {
                        ...
                        if(parseInt(user.b)!=1) {
                            var userstatus = jqcc.cometchat.getThemeArray('buddylistStatus', user.id);
                ...
                loadChatroomList : function(item) {
                    ...
                    $.each(item, function(i,room) {
                        ...
                        if(jqcc.cometchat.getChatroomVars('currentroom') == room.id) {
                            selected = 'cometchat_roomselected';
                        }*/
                        ...
                        if(room.type == 1) {
                            roomtype = '<div class="cometchat_grouptype"><img src="'+baseUrl+'themes/'+calleeAPI+'/images/lock.png" class="cometchat_grouptypeimage" /></div>';
                        }
                        ...
                        var deletegroup = '';
                        if((room.s == 1 || jqcc.cometchat.checkModerator() == 1) && room.createdby != 0){
                            renamegroup = '<div class="cometchat_grouprename" title="<?php echo $chatrooms_language[80]; ?>" onclick = "javascript:jqcc.'+[calleeAPI]+'.renameChatroom(event,\''+room.id+'\');"><img class="cometchat_grouprenameimage" src="'+baseUrl+'themes/'+calleeAPI+'/images/pencil_buddylist.png"></div>';
                            deletegroup = '<div class="cometchat_groupdelete" title="<?php echo $chatrooms_language[58]; ?>" onclick = "javascript:jqcc.cometchat.deleteChatroom(event,'+room.id+');"><img class="cometchat_groupdeleteimage" src="'+baseUrl+'themes/'+calleeAPI+'/images/remove.png"></div>';
                        }

                        temp = '<div id="cometchat_grouplist_'+room.id+'" class="cometchat_grouplist" onmouseover="jqcc(this).addClass(\'cometchat_grouplist_hover\');" onmouseout="jqcc(this).removeClass(\'cometchat_grouplist_hover\');" onclick="javascript:jqcc.cometchat.chatroom(\''+room.id+'\',\''+urlencode(shortname)+'\',\''+room.type+'\',\''+room.i+'\',\''+room.s+'\',\'1\',\'1\');" amount="'+unreadmessagecount+'"><div class="cometchat_groupscontentavatar"><img class="cometchat_groupscontentavatarimage" src="'+baseUrl+'themes/'+calleeAPI+'/images/group.svg"></div><div><div class="cometchat_groupscontentname">'+longname+'</div></div>'+deletegroup+renamegroup+roomtype+usercount+'<div class="cometchat_unreadCount cometchat_floatR" style="'+msgcountercss+'">'+unreadmessagecount+'</div></div>';
                ...
                displayChatroomMessage: function(item,fetchedUsers) {
                        ...
                        if (message != '') {
                                ...
                                if($("#cometchat_groupmessage_"+incoming.id).length > 0) {
                                    ...
                                    if((incoming.fromid != settings.myid) || (typeof incoming.botid != "undefined" && incoming.botid != 0)) {
                                        ...
                                        var fromavatar = '<a class="cometchat_floatL"><img class="ccmsg_avatar" src="'+jqcc.cometchat.getThemeArray('buddylistAvatar', incoming.fromid)+'" title="'+fromname+'"/></a>';

                                        if(typeof incoming.botid != "undefined" && incoming.botid != 0) {
                                            fromavatar = '<a class="cometchat_floatL"><img class="ccmsg_avatar" src="'+jqcc.cometchat.getThemeArray('botlistAvatar', incoming.botid)+'" title="'+jqcc.cometchat.getThemeArray('botlistName', incoming.botid)+'"/></a>';
                                        }
                                        var sentdata = $[calleeAPI].getTimeDisplay(ts,incoming.id);
                                        var hw_ts = '';
                                        if(message.indexOf('cometchat_hw_lang')!=-1){
                                ...
                                if(jqcc.cometchat.getChatroomVars('owner') || jqcc.cometchat.getChatroomVars('isModerator') || (jqcc.cometchat.getChatroomVars('allowDelete') == 1 && incoming.fromid == settings.myid)) {
                                    if(grouppopup.find("#cometchat_groupmessage_"+incoming.id).find(".delete_msg").length < 1) {
                                        ...
                                        grouppopup.find('#cometchat_groupmessage_'+incoming.id).find("."+cometchat_ts_class).after('<span class="delete_msg" style="'+cometchat_ts_style+';'+cometchat_del_style+';" onclick="javascript:jqcc.cometchat.confirmDelete(\''+incoming.id+'\',\''+incoming.chatroomid+'\');"><img class="hoverbraces" src="'+baseUrl+'themes/docked/images/bin.svg"></span>');
                                    }
                            ...
                            if (message != '' && (typeof(receivedcrunreadmessages[incoming.chatroomid])=='undefined' || receivedcrunreadmessages[incoming.chatroomid] < incoming.id)){
                                ...
                                if (incoming.fromid != settings.myid && settings.messageBeep == 1) {
                                    if ((typeof $.cookie(settings.cookiePrefix+"sound") == 'undefined' || $.cookie(settings.cookiePrefix+"sound") == null) || $.cookie(settings.cookiePrefix + "sound") == 'true') {
                                ...
                                if (typeof(jqcc[jqcc.cometchat.getChatroomVars('calleeAPI')].addMessageCounter) == "function" && incoming.fromid != settings.myid){
                                    if ((typeof $.cookie(settings.cookiePrefix+"sound") == 'undefined' || $.cookie(settings.cookiePrefix+"sound") == null) || $.cookie(settings.cookiePrefix + "sound") == 'true') {
                    ...
                    renameChatroom: function(event,id){
                        ...
                        jqcc('#cometchat_grouplist_'+id).find('.cometchat_groupscontentname').css('visibility','hidden');
                            ...
                            jqcc.ajax({
                                ...
                                success: function(data) {
                                    if (data == 0) {
                                        ...
                                        $('#cometchat_group_'+id).find('.cometchat_groupname').text(name);
                            ...
                            if (message != '') {
                                ...
                                if(jqcc.cometchat.getChatroomVars('owner') || jqcc.cometchat.getChatroomVars('isModerator') || (jqcc.cometchat.getChatroomVars('allowDelete') == 1 && incoming.fromid == settings.myid)) {
                                    ...
                                    if(grouppopup.find("#cometchat_groupmessage_"+incoming.id).find(".delete_msg").length < 1) {
                                       ...
                                       deleteMessage = '<span class="delete_msg" style="'+cometchat_ts_style+';'+cometchat_del_style+';" onclick="javascript:jqcc.cometchat.confirmDelete(\''+incoming.id+'\',\''+id+'\');"><img class="hoverbraces" src="'+baseUrl+'themes/docked/images/bin.svg"></span>';
                                    }
                                }
                                if (incoming.fromid != settings.myid) {
                                    if(typeof(jqcc.cometchat.getThemeArray('buddylistAvatar', incoming.fromid))=='undefined'){
                                    ...
                                    var fromavatar = '<a class="cometchat_floatL" href="'+jqcc.cometchat.getThemeArray('buddylistLink', incoming.fromid)+'"><img class="ccmsg_avatar" src="'+jqcc.cometchat.getThemeArray('buddylistAvatar', incoming.fromid)+'" title="'+fromname+'"/></a>';
                                   var sentdata = $[calleeAPI].getTimeDisplay(ts,incoming.id);
                                   ...
                                   if((message.indexOf('<img')==-1 && message.indexOf('src')==-1) || (smileycount > 0 && smileymsg != '')){
                                    ...
                                    temp += '<div class="cometchat_time cometchat_time_'+msg_date_class+' '+date_class+'" msg_format="'+msg_date_format+'">'+msg_date+'</div><div class="cometchat_chatboxmessage" id="cometchat_groupmessage_'+incoming.id+'">'+fromavatar+'<div class="'+add_bg+' '+'cometchat_ts_margin cometchat_floatL">'+usernamecontent+'<span id="cc_groupmessage_'+incoming.id+'" class="cometchat_msg">'+message+'</span></div>'+sentdata_box+' '+add_arrow_class+deleteMessage+'</div>';
                                } else {
                                    var sentdata = $[calleeAPI].getTimeDisplay(ts,incoming.id);
                                    var sentdata_box = "<span class=\"cometchat_ts\">"+sentdata+"</span>";
                                    if((message.indexOf('<img')==-1 && message.indexOf('src')==-1) || (smileycount > 0 && smileymsg != '')){
                                    ...
                                    temp += '<div class="cometchat_time cometchat_time_'+msg_date_class+' '+date_class+'" msg_format="'+msg_date_format+'">'+msg_date+'</div><div class="cometchat_chatboxmessage" id="cometchat_groupmessage_'+incoming.id+'"><div class="'+add_bg+' '+'cometchat_ts_margin cometchat_self_msg cometchat_floatR"><span id="cc_groupmessage_'+incoming.id+'" class="cometchat_msg">'+message+'</span><span id="cometchat_chatboxseen_'+incoming.id+'"></span></div>'+sentdata_box+' '+add_arrow_class+deleteMessage+'</div>';
                                }
                            }
                        ...
                        if(mobileDevice){
                         ...
                         $.each(data, function(i, incoming){
                           ...
                           if(($(".cometchat_chatboxmessagecontent").next().hasClass("cometchat_ts_other")) && (cc_dir == 1)){
                               var cometchat_ts_margin_left = $("#cometchat_groupmessage_"+incoming.id+" .cometchat_ts_margin").outerWidth(true)+30;
                               jqcc('#cometchat_groupmessage_'+incoming.id).find('.cometchat_ts_other').css('margin-left',cometchat_ts_margin_left);
                           }
                         });
                    ...
                    addMessageCounter: function(id, amount, add){
                        ...
                        if(jqcc.cometchat.getCcvariable().internalVars.hasOwnProperty('chatboxstates')) {
                            ...
                            if(cc_states.hasOwnProperty(key)){
                                ...
                                if(add == 1){
                                    amount = parseInt($('#cometchat_grouplist_'+id).attr('amount'))+parseInt(amount);
                                }
                                if(amount==0){
                    ...
                    closeChatroom: function(roomno){
                        ...
                        if(cometchat_group_popup.length != 0){
                            ...
                            jqcc.cometchat.updateChatBoxState({id:roomno,g:1,s:0});
