...
EOD;
		if (($allowUsers == 1 && $userid < '10000000') || ($allowGuests == 1 && $userid > '10000000')) {
			$listItems .= <<<EOD
				...
				<script type="text/javascript">
		            ...
		            $(document).ready(function(){
	                    ...
	                    auth_logout.click(function(event){
	                        ...
	                        auth_logout.css('background','url('+baseUrl+'themes/docked/images/loading.gif) no-repeat top left');
	                        jqcc.ajax({
	                            url: baseUrl+'functions/login/logout.php',
	                            dataType: 'jsonp',
	                            success: function(){
	                            	auth_logout.css('background','url('+baseUrl+'themes/docked/images/logout.png) no-repeat top left');
