...
<div id="content" style="width:auto">
		...
		<div>
			<div id="centernav" style="width:380px">
				...
				<div class="title long">If yes, show total number of users in chatrooms</div><div class="element toppad"><input name="showChatroomUsers" $showChatroomUsersYes value="1"   type="radio">Yes <input name="showChatroomUsers" value="0" type="radio" $showChatroomUsersNo>No</div>
				<div style="clear:both;padding:10px;"></div>
				...
				<div class="title long">Show username in chatrooms</div><div class="element"><input name="showUsername" $showUsernameYes value="1"   type="radio">Yes <input name="showUsername" value="0" type="radio" $showUsernameNo>No</div>
				<div style="clear:both;padding:10px;"></div>
				{$pcb}
			</div>
		</div>
