 ...
 <body class="navbar-fixed sidebar-nav fixed-nav" style="background-color:white;white;overflow-y:hidden;"">
             <div class="col-sm-6 col-lg-6">
                ...
                <div class="card-block">
		          ...
		          <div class="form-group row">
		            <div class="col-md-6">
		              <label for="ccyear">Open in new window:</label>
		            </div>
		             <div class="col-md-6">
		              <label class="">
			              <div style="position:relative;"><input style="position: absolute;" type="radio" $mobileNewWindowYes value="1" name="mobileNewWindow"></div><span style="padding-left:25px;">Yes</span>
			            </label>
			            <label class="">
			              <div style="position:relative;"><input style="position: absolute;" type="radio" $mobileNewWindowNo value="0" name="mobileNewWindow"></div><span style="padding-left:25px;">No</span>
			            </label>
		            </div>
		          </div>
		          ...
		          <div class="form-group row">
		            <div class="col-md-6">
		              ...
		              <select class="form-control" name="mobiletabConfirmOnAllMessages" id="pluginTypeSelector" style="width:75%;">
