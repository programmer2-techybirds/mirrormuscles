	...
	$body = <<<EOD
	  ...
	  <div class="col-sm-12 col-lg-12">
	    <div class="card">
	      ...
	      <div class="card-block">
	      <iframe height="500px" width="100%"  style="margin-left:-28px;border:none;" src="?module=dashboard&action=loadexternal&type=extension&name=mobileapp{$queryString}"></iframe>
	      </div>
	    </div>
	  </div>
	  <script type="text/javascript">
