...
class PushNotification {
	...
	public function __construct($settings=array()) {
		...
		$this->provider  = setConfigValue('provider_pushnotification','OneSignal');
	...
	public function sendNotification($channel, $messageData, $isChatroom = '0', $isAnnouncement = '0',$isWRTC = '0') {
		$response = $this->providerObject->sendNotification($channel, $messageData, $isChatroom = '0', $isAnnouncement = '0',$isWRTC = '0');
		return $response;
	}
