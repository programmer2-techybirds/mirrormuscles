...
function invite() {
	global $userid, $broadcast_language, $language, $embed, $embedcss, $lightboxWindows, $guestsMode, $cookiePrefix, $chromeReorderFix, $hideOffline, $basedata, $plugins, $cc_theme, $firstguestID;
