...
<html>
	<head>
		...
		<link type="text/css" rel="stylesheet" media="all" href="../../css.php?type=module&name=twitter&cc_theme={$cc_theme}" />
	...
	<body>
		<div style="width:100%;margin:0 auto;margin-top: 0px;height: 100%;">
			<div class="cometchat_wrapper">
				<div class="followme">
					<a target="_blank" href="http://www.twitter.com/{$twitteruser}"><img src="layouts/{$theme}/images/follow.png"></a><br>
