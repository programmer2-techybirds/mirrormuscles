...
${$addonname.'_language'}['chatroom_invite']			= setLanguageValue('chatroom_invite','has invited you to join group ',$lang,$addontype,$addonname);
...
${$addonname.'_language'}['cr_user_options']			= setLanguageValue('cr_user_options','Group user options',$lang,$addontype,$addonname);
...
${$addonname.'_language'}['already_invited']			= setLanguageValue('already_invited','Already invited to this group.',$lang,$addontype,$addonname);
