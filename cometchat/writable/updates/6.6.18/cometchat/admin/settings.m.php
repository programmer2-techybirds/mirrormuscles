...
EOD;
$cometchatStatus = "";
$cometchatStatus = (defined('BAR_DISABLED') && BAR_DISABLED == 0)? "" : "checked";
$ccupdate = (defined('BAR_DISABLED') && BAR_DISABLED == 0) ? "value=0" : "value";
	$body = <<<EOD
	<div class="row">
    <div class="col-sm-12 col-lg-12">
    <div class="card">
			...
			<div class="form-group row">
				<div class="col-md-12">
		      	<label class="form-control-label">Enable Typing Notification?</label>
		      		<div class=""><label class=""><div style="position:relative;top:4px;"><input style="position: absolute;" type="radio" name="typ" value="1" $isTypingy ></div><span style="padding-left:25px;">Yes</span></label><label class=""><div style="position:relative;top:4px;"><input style="position: absolute;left:8px;" type="radio" name="typ" value="1" $isTypingn value="0"></div><span style="padding-left:36px;">No</span></label></div>
				</div>
			</div>
...
function updateauthmode() {
	global $ts;
	global $ccactiveauth;
	global $firebaseAPIKey, $firebaseAuthDomain, $firebaseProjectID;

	$_POST['firebaseAPIKey'] = empty($_POST['firebaseAPIKey']) ? $firebaseAPIKey : $_POST['firebaseAPIKey'];
	$_POST['firebaseAuthDomain'] = empty($_POST['firebaseAuthDomain']) ? $firebaseAuthDomain : $_POST['firebaseAuthDomain'];
	$_POST['firebaseProjectID'] = empty($_POST['firebaseProjectID']) ? $firebaseProjectID : $_POST['firebaseProjectID'];
