    ...
    $.ccdocked = (function(){
        ...
        return {
            ...
            composenewBroadcast:function(){
                ...
                var ncbframe = '<div><iframe id="cometchat_trayicon_newchat_iframe" src="'+baseUrl+'modules/broadcastmessage/index.php?cc_theme=docked&basedata='+cc_basedata+'" height="316" width="100%" style="border:0px;"></div>';
