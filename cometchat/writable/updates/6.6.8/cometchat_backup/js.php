...
if(!empty($_REQUEST['admin'])){
	...
	if(file_exists(dirname(__FILE__).DIRECTORY_SEPARATOR."layouts".DIRECTORY_SEPARATOR.$theme.DIRECTORY_SEPARATOR.'config.php')){
		include_once(dirname(__FILE__).DIRECTORY_SEPARATOR."layouts".DIRECTORY_SEPARATOR.$theme.DIRECTORY_SEPARATOR.'config.php');
	}else{
		include_once(dirname(__FILE__).DIRECTORY_SEPARATOR.'layouts'.DIRECTORY_SEPARATOR.'docked'.DIRECTORY_SEPARATOR.'config.php');
	}
	$jsfile = dirname(__FILE__).DIRECTORY_SEPARATOR.'writable'.DIRECTORY_SEPARATOR.$writable.DIRECTORY_SEPARATOR.$cbfn.$type.$name.$theme.$color.$lang.$enablecustomjs.'.js';
	$cometchat = array();
	if(file_exists($jsfile)&&DEV_MODE!=1){
		...
		if(($type!='core'||$name!='default')&&($type!='extension'||($type=='extension'&&$name=='jabber'))&&($type!='external')){
			...
			if($type=='core'){
				...
				if(file_exists(dirname(__FILE__).DIRECTORY_SEPARATOR.$type."s".DIRECTORY_SEPARATOR.$name.DIRECTORY_SEPARATOR.'layouts'.DIRECTORY_SEPARATOR.$theme.DIRECTORY_SEPARATOR."js".DIRECTORY_SEPARATOR.$theme.".js")){
					include_once(dirname(__FILE__).DIRECTORY_SEPARATOR.$type."s".DIRECTORY_SEPARATOR.$name.DIRECTORY_SEPARATOR.'layouts'.DIRECTORY_SEPARATOR.$theme.DIRECTORY_SEPARATOR."js".DIRECTORY_SEPARATOR.$theme.".js");
				}
				if($name=='whiteboard') {
			...
			if($theme=='embedded' && (($disableGroupTab == 0) || !empty($_REQUEST['chatroomid']) || !empty($_REQUEST['chatroomsonly']))){
			...
			if($theme=='embedded' && ($disableGroupTab == 0)){
			...
			if(empty($cbfn) || $cbfn=='desktop'){
				if(file_exists(dirname(__FILE__).DIRECTORY_SEPARATOR."layouts".DIRECTORY_SEPARATOR.$theme.DIRECTORY_SEPARATOR."js".DIRECTORY_SEPARATOR.$theme.".js")){
					include_once(dirname(__FILE__).DIRECTORY_SEPARATOR."layouts".DIRECTORY_SEPARATOR.$theme.DIRECTORY_SEPARATOR."js".DIRECTORY_SEPARATOR.$theme.".js");
				}else{
					include_once(dirname(__FILE__).DIRECTORY_SEPARATOR."layouts".DIRECTORY_SEPARATOR.$theme.DIRECTORY_SEPARATOR."js".DIRECTORY_SEPARATOR."docked.js");
				}
			...
			if(!empty($client) && file_exists(dirname(__FILE__).DIRECTORY_SEPARATOR.'cloud'.DIRECTORY_SEPARATOR."integrations".DIRECTORY_SEPARATOR.$cms.'.js')&&empty($cbfn)&&empty($cc_theme)){
				include_once(dirname(__FILE__).DIRECTORY_SEPARATOR.'cloud'.DIRECTORY_SEPARATOR.'integrations'.DIRECTORY_SEPARATOR.$cms.'.js');
			}
			...
			if(!empty($enablecustomjs) && $enablecustomjs == 1 && !empty($customjs) && empty($cbfn)){
				echo $customjs;
			}
