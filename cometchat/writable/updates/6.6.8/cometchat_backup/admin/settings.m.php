...
function index() {
	...
	foreach ($options as $option => $result) {
		...
		if ($result[0] == 'choice') {
			if (${$option} == 1) {
				$form .='<div class=""><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;" name="'.$option.'" value="1" type="radio" checked ></div><span style="padding-left:25px;">Yes</span></label><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;left:8px;" name="'.$option.'" value="0" type="radio"></div><span style="padding-left:30px;">No</span></label></div>';
			} else {
				$form .='<div class=""><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;" name="'.$option.'" value="1" type="radio" ></div><span style="padding-left:25px;">Yes</span></label><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;left:8px;" name="'.$option.'" value="0" type="radio" checked></div><span style="padding-left:30px;">No</span></label></div>';
			}
		}
...
$disabled_cometchat = <<<EOD
	...
	<div class="col-md-12"><label class="form-control-label">Disable CometChat:</label>
		<div class=""><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;" name="BAR_DISABLED" value="1" $cc_bary type="radio" ></div><span style="padding-left:25px;">Yes</span></label><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;left:8px;" name="BAR_DISABLED" value="0" $cc_barn type="radio"></div><span style="padding-left:30px;">No</span></label></div>
	</div></div>
EOD;
$generalsettings = <<<EOD
		<div class="col-sm-12 col-lg-12">
	...
	<div class="card">
		...
		<div class="card-block">
			<form action="?module=settings&action=updatewhosonline&ts={$ts}" method="post">
				...
				<div class="form-group row">
					<div class="col-md-12">
			      	<label class="form-control-label">Show all online users (Including Non-friends)</label>
			      		<div class=""><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;" name="DISPLAY_ALL_USERS" value="1" $dy type="radio" ></div><span style="padding-left:25px;">Yes</span></label><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;left:8px;" name="DISPLAY_ALL_USERS" value="0" $dn type="radio"></div><span style="padding-left:30px;">No</span></label></div>
					</div>
				</div>
...
function updatecmssettings(){
	global $ts;
	if(empty($_POST['hideDockedLayout'])){
		$_POST['hideDockedLayout'] = 0;
	}
	$GLOBALS['integration']->updateUserRoles();
	configeditor($_POST);
	$_SESSION['cometchat']['error'] = 'Setting updated successfully';
	header("Location:?module=settings&action=cmssettings&ts={$ts}");
...
function devsettings() {
	...
	$usecslegacyn = $usecslegacyy = $showSiteUrl = $baseurl = "";
								...
								<div class="form-group row">
									<div class="col-md-12">
							      	<label class="form-control-label">Dev Mode:</label>
							      		<div class=""><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;" type="radio" name="DEV_MODE" value="1" $dmo ></div><span style="padding-left:25px;">Yes</span></label><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;left:8px;" type="radio" name="DEV_MODE" value="0" $dmof></div><span style="padding-left:30px;">No</span></label></div>
									</div>
								</div>
								...
								<div class="form-group row">
									<div class="col-md-12">
							      	<label class="form-control-label">Error Logging:</label>
							      		<div class=""><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;" type="radio" name="ERROR_LOGGING" value="1" $elo ></div><span style="padding-left:25px;">Yes</span></label><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;left:8px;" type="radio" name="ERROR_LOGGING" value="0" $elof></div><span style="padding-left:30px;">No</span></label></div>
									</div>
								</div>
								...
								<div class="form-group row">
									<div class="col-md-12">
							      	<label class="form-control-label">Cross Domain:</label>
							      		<div class=""><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;" type="radio" id="cdon" name="CROSS_DOMAIN" value="1" $cdo ></div><span style="padding-left:25px;">Yes</span></label><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;left:8px;" type="radio" id="cdoff" name="CROSS_DOMAIN" value="0" $cdof></div><span style="padding-left:30px;">No</span></label></div>
									</div>
								</div>
								...
								<div class="form-group row">
									<div class="col-md-12">
							      	<label class="form-control-label">Use CometService Legacy? (Not recommended; Contact CometChat Support before enabling)</label>
							      		<div class=""><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;" type="radio" name="USE_CS_LEGACY" value="1" $usecslegacyy ></div><span style="padding-left:25px;">Yes</span></label><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;left:8px;" type="radio" $usecslegacyn name="USE_CS_LEGACY" value="0"></div><span style="padding-left:30px;">No</span></label></div>
									</div>
								</div>
...
<div class="row">
    ...
    <div class="card">
      	...
      	<label class="form-control-label">Use CometService?</label>
			<div class=""><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;" id="cs1" class="comet" type="radio" name="dou" value="1" $cometchecky type="radio" ></div><span style="padding-left:25px;">Yes</span></label><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;left:8px;" id="cs2" class="comet" type="radio" $cometcheckn name="dou" value="0"></div><span style="padding-left:30px;">No</span></label></div>
		</div></div>
			...
			<div class="form-group row">
				<div class="col-md-12">
		      	<label class="form-control-label">Use Self-hosted CometService?</label>
		      		<div class=""><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;" type="radio" name="dos" value="1" $cometselfhostedy ></div><span style="padding-left:25px;">Yes</span></label><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;left:8px;" type="radio" name="dos" value="0" $cometselfhostedn></div><span style="padding-left:30px;">No</span></label></div>
				</div>
			</div>
			...
			<div class="form-group row">
				<div class="col-md-12">
		      	<label class="form-control-label">Enable Typing Notification?</label>
		      		<div class=""><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;" type="radio" name="typ" value="1" $isTypingy ></div><span style="padding-left:25px;">Yes</span></label><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;left:8px;" type="radio" name="typ" value="1" $isTypingn value="0"></div><span style="padding-left:30px;">No</span></label></div>
				</div>
			</div>
			...
			<div class="form-group row">
				<div class="col-md-12">
		      	<label class="form-control-label">Enable Receipt Notification?</label>
		      		<div class=""><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;" type="radio" name="rec" value="1" $messagereceipty ></div><span style="padding-left:25px;">Yes</span></label><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;left:8px;" type="radio" $messagereceiptn name="rec" value="0"></div><span style="padding-left:30px;">No</span></label></div>
				</div>
			</div>
			...
			<div class="form-group row">
				<div class="col-md-12">
		      	<label class="form-control-label">Synchronize messages across all user devices? (Not recommended; Will increase usage of CometService on your server)</label>
		      		<div class=""><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;" type="radio" name="cs_sync" value="1" $messagesyncy ></div><span style="padding-left:25px;">Yes</span></label><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;left:8px;" type="radio" $messagesyncn name="cs_sync" value="0"></div><span style="padding-left:30px;">No</span></label></div>
				</div>
			</div>
	    </div>
		<div class="row col-md-10" style="padding-bottom:5px;"><br>
	...
	$(document).ready(function(){
		...
		$('input:radio[name=dos]').change(function(){
			...
			if(selfhostedenabled == 1){
				...
				$('input[name=keya]').removeAttr('required');
				$('input[name=keyb]').removeAttr('required');
				$('input[name=keyc]').removeAttr('required');
			} else {
				$('.serverurl_text').hide();
				$('.cckeys').show();
...
function searchlogs() {
	...
	$query = sql_query('admin_searchlogs',array('usertable_userid'=>$usertable_userid, 'usertable_username'=>$usertable_username, 'usertable'=>$usertable, 'username'=>sanitize_core($username)));
	$userslist = '';
		...
		<div class="form-group row">
			<div class="col-md-12">
	      	<label class="form-control-label">Enable Guest Chat:</label>
	      		<div class=""><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;" type="radio" name="guestsMode" value="1" $dy ></div><span style="padding-left:25px;">Yes</span></label><label class=""><div style="position:relative;top:2px;"><input style="position: absolute;left:8px;" type="radio" $dn name="guestsMode" value="0"></div><span style="padding-left:30px;">No</span></label></div>
			</div>
		</div>
EOD;
