        ...
        <div class="col-sm-12 col-lg-12">
            ...
            <div class="card-block">
              <form action="?module=bots&action=updatBotsetting&ts={$ts}" method="post" onSubmit="">
                  ...
                  <div class="row">
                    <label class="col-md-2 form-control-label" style="padding-top:10px;">
                      Enable Bots?
                    </label>
                    <label class="col-md-1" style="padding-top:10px;">
                      <div style="position:relative;top:4px;"><input style="position: absolute;" type="radio" id="inline-radio1"  name="usebots" value="1" $disableBoty ></div><span style="padding-left:21px;">Yes</span>
                    </label>
                     <label class="col-md-1" style="padding-top:10px;">
                      <div style="position:relative;"><input style="position:absolute;top:4px;left:4px;" type="radio" id="inline-radio2" name="usebots" value="0" $disableBotn></div><span style="padding-left:24px;">No</span>
                    </label>
                    <label class=""><input type="submit" value="Update" class="btn btn-primary"></label>
                  </div>
              </form>
            </div>
            </div>
