...
if ($action == 'request') {
	...
	if($optionalmessage == 0){
		$message = $writeboard_language[2]." <a href='javascript:void(0);' class='accept_Write' to='".$userid."' random='".$room."' chatroommode='0' mobileAction=\"javascript:jqcc.ccwriteboard.accept('".$userid."','".$room."');\">".$writeboard_language[3]."</a> ".$writeboard_language[4];
...
if ($action == 'writeboard') {
	...
	if (!empty($chatroommode)) {
		$message = $writeboard_language[2]." <a href='javascript:void(0);' class='accept_Write' to='".$userid."' random='".$room."' chatroommode='".$_REQUEST['chatroommode']."' mobileAction=\"javascript:jqcc.ccwriteboard.accept('".$userid."','".$room."','".$_REQUEST['chatroommode']."');\">".$writeboard_language[3]."</a>";
