...
foreach ($ccactiveauth as $key) {
	 $authpopup .= '<img onclick="window.open(\"'.BASE_URL.'functions/login/signin.php?network='.strtolower($key).'\",\"socialwindow\",\"status=0,toolbar=0,menubar=0,directories=0,resizable=1,location=0,status=0,scrollbars=0, width=200,height=200\");return false;" src="'.BASE_URL.'themes/'.$theme.'/images/login'.strtolower($key).'.png" class="auth_options"></img>';
}
