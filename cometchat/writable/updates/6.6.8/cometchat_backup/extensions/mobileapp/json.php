...
$response['mobile_theme']['login_button_pressed']= $response['mobile_theme']['login_button'] = $themeSettings['primary_color'];
...
$response['mobile_theme']['actionbar_color']= $themeSettings['tab_title_background'] = $themeSettings['primary_color'];
$response['mobile_theme']['primary_color']= $themeSettings['primary_color'];
$response['mobile_theme']['secondary_color']= $themeSettings['secondary_color'];
$response['mobile_theme']['right_bubble_color']= $themeSettings['primary_color'];

/* ------------ config starts ------------*/

$response['mobile_config']['social_auth_enabled']= checkAuthMode('social'); //If you are using client's social login. Set this to 1.
