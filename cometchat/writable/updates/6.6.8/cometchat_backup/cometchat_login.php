...
<head>
	...
	<style>
		...
		input:-webkit-autofill, textarea:-webkit-autofill, select:-webkit-autofill{
		    ...
		    color: <?php echo $themeSettings['primary_color']; ?> !important;
		}
		#mainContainer {
			overflow: hidden;
			background: white;
		...
		#userNameBox{
			border: 0px solid <?php echo $themeSettings['primary_color']; ?>;
		...
		#signIn {
			...
			border : none;
			padding: 5px;
			background-color: <?php echo $themeSettings['primary_color']; ?>;
		...
		.rememberPasswordSpan {
			...
			float: left;
			height: 20px;
			color: <?php echo $themeSettings['primary_color']; ?>
		}
		#companyLogoDiv img{
			margin-left: 6px;
		}
        ...
        #signUp {
            ...
            border: 2px solid <?php echo $themeSettings['primary_color']; ?>;
            font-family: "Lucida Grande",Verdana,Arial,"Bitstream Vera Sans",sans-serif;
		    font-size: 13px;
		    padding: 6px 10px;
		    border-radius: 15px;
