        ...
        return {
            ...
            loggedOut: function(){
                ...
                if(settings.ccauth.enabled=="1" && !mobileDevice){
                    ...
                    jqcc.each(authactive,function(i,auth) {
                        ccauthpopup += '<div  class="auth_options '+auth.toLowerCase()+'_auth_options" onclick="window.open(\''+baseUrl+'functions/login/signin.php?network='+auth.toLowerCase()+'\',\'socialwindow\',\'status=0,toolbar=0,menubar=0,directories=0,resizable=1,location=0,status=0,scrollbars=0, width=200,height=200\')" ><img src="'+baseUrl+'layouts/embedded/images/login'+auth.toLowerCase()+'.svg"><span>'+auth.toLowerCase()+'</span></div>';
                    });
