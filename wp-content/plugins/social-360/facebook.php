...
class AheadzenFacebook
{
	...
	*/
	function __construct()
	{
		...
		$this->fb_redirect_url = $theurl.'?hauth_done=Facebook';
	...
	*/
	...
	{		
		$loginURL = $this->fb_authorize_url.'?client_id='.$this->api_id.'&redirect_uri='.urlencode($this->fb_redirect_url).'&scope='.urlencode($this->fb_scope).'&display=popup';
		$loginURL = $this->fb_authorize_url.'?client_id='.$this->api_id.'&redirect_uri='.urlencode($this->fb_redirect_url).'&state='.urlencode($this->fb_state).'&sdk='.urlencode($this->fb_sdk).'&scope='.urlencode($this->fb_scope).'&display=popup';
