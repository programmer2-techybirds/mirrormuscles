    ...
    <div class="section">
        ...
        <div id="tabs">
            ...
            <ul>
                ...
                <li><a href="#tabs-3"><?php _e("Advanced", 'woocommerce-currency-switcher') ?></a></li>
                <?php if ($this->is_use_geo_rules()): ?>
                    <li><a href="#tabs-4"><?php _e("GeoIP rules", 'woocommerce-currency-switcher') ?></a></li>
                <?php endif; ?>
                <li><a href="#tabs-5"><?php _e("Info", 'woocommerce-currency-switcher') ?></a></li>
