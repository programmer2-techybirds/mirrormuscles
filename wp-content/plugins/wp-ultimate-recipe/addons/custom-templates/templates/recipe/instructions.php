...
<div<?php echo $this->style(); ?>>
    ...
    foreach( $groups as $index => $group ) {
        ...
        echo '<div class="wpurp-recipe-instruction-group-container wpurp-recipe-instruction-group-container-' . $group_class . '">';
        ...
        for( $i = 0; $i < count($instructions); $i++ ) {
            ...
            if( $this->show_images && $instruction['image'] != '' ) {
                ...
                if( WPUltimateRecipe::option( 'recipe_images_clickable', '0' ) == 1 ) {
                    ...
                    $out .= '<img src="' . $thumb_url . '" alt="' . $alt_tag . '" title="' . $title_tag . '"' . $this->style('img') . '/>';
                    $out .= '</a>';
                } else {
                    $out .= '<img src="' . $thumb_url . '" alt="' . $alt_tag . '" title="' . $title_tag . '"' . $this->style('img') . '/>';
                }
