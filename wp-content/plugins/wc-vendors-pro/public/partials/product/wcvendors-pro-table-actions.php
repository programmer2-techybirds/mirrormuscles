...
<div class="wcv_actions wcv-cols-group repeat_data"> 
	<div class="all-50">
...
<script type="text/javascript">
	jQuery(document).ready(function(){
		jQuery("div.wcv-grid div:nth-child(5)").css("display", "none");
		jQuery("div.wcv-grid div:nth-child(6)").css("display", "none");
