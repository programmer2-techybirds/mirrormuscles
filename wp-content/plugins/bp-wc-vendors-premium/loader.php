...
/*
Plugin Name: BP WC Vendors (Premium)
...
class BP_WC_Vendors
{
    ...
    public function __construct()
    {
        ...
        add_action(
            ...
            array( $this, 'bp_wcv_admin_js' ),
            1,
            10
        );
        add_action(
            'admin_enqueue_scripts',
            array( $this, 'bp_wcv_admin_css' ),
            1,
            10
        );
        add_action(
            'wp_enqueue_scripts',
            array( $this, 'bp_wcv_front_js_css' ),
            1,
            10
        );
     ...
     * @since 0.1
     */
    public function bp_wcv_admin_css( $hook_suffix )
    {
     ...
     * @since 1.1
     */
    public function bp_wcv_admin_js( $hook_suffix )
    {
        if ( $hook_suffix != 'toplevel_page_bp_wcv_screen' ) {
            return;
        }
     ...
     * @since 0.1
     */
    public function bp_wcv_front_js_css()
    {
    }
    
    public function bp_wcv_bp_init()
    {
        global  $bp ;
...
function bp_wcv_special_admin_notice_dismissed()
{
    ...
    if ( isset( $_GET['bp_wcv_special_admin_notice_dismissed'] ) ) {
        add_user_meta(
            $user_id,
            'bp_wcv_special_admin_notice_dismissed',
            'true',
            true
        );
    }
