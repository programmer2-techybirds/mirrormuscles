...
module.exports = function ( grunt ) {
    ...
    grunt.initConfig( {
        ...
        uglify: {
            ...
            frontend: {
                files: {
                    'assets/js/buddyboss-media.min.js': [ 'assets/js/buddyboss-media.js' ],
                    'assets/js/jquery.tooltipster.min.js': [ 'assets/js/jquery.tooltipster.js' ]
                }
            },
        },
        /*
        ...
        checktextdomain: {
            options: {
                text_domain: [ 'buddyboss-media', 'buddypress', 'bbpress', 'buddypress-inbox', 'buddyboss-media', 'buddyboss-welcome-experience' ], //Specify allowed domain(s)
        ...
        makepot: {
            target: {
                options: {
                    ...
                    potFilename: 'buddyboss-media.pot', // Name of the POT file.
