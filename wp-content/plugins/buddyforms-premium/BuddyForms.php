...
/**
 * Plugin Name: Form Builder & Front End Editor BuddyForms (Premium)
...
if ( !class_exists( 'BuddyForms' ) ) {
    ...
    class BuddyForms
    {
         ...
         * @param $hook_suffix
         */
        public function admin_js( $hook_suffix )
        {
            global  $post ;
         ...
         * @since 1.0
         */
        public function front_js_loader()
        {
        ...
        public function front_js_css()
        {
            ...
            wp_enqueue_script( 'jquery-ui-dialog' );
            wp_enqueue_style(
                'buddyforms-jquery-ui-style',
                '//ajax.googleapis.com/ajax/libs/jqueryui/' . $jquery_version . '/themes/smoothness/jquery-ui.css',
                array(),
                $jquery_version
            );
            ...
            wp_enqueue_style( 'buddyforms-select2-css', plugins_url( 'assets/resources/select2/dist/css/select2.min.css', __FILE__ ) );
            wp_enqueue_script( 'buddyforms-jquery-ui-timepicker-addon-js', plugins_url( 'assets/resources/jquery-ui-timepicker-addon/jquery-ui-timepicker-addon.js', __FILE__ ), array( 'jquery-ui-core', 'jquery-ui-datepicker', 'jquery-ui-slider' ) );
