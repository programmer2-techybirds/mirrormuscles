...
module.exports = function ( grunt ) {
    ...
    grunt.initConfig( {
        ...
        cssmin: {
            ...
            target: {
                files: {
                    'assets/css/buddyboss-inbox.min.css': [ 'assets/css/buddyboss-inbox.css', 'assets/css/magnific-popup.css' ]
                }
            }
        },
        /*
        ...
        uglify: {
            ...
            frontend: {
                src: [
                    ...
                    'assets/js/buddyboss-inbox.js',
                ],
                dest: 'assets/js/buddyboss-inbox.min.js'
            },
        },
        /*
         * Check text domain
        ...
        checktextdomain: {
            options: {
                text_domain: [ 'buddyboss-inbox', 'buddypress', 'bbpress', 'woothemes-sensei', 'wcvendors-pro', 'woocommerce' ], //Specify allowed domain(s)
        ...
        makepot: {
            target: {
                options: {
                    ...
                    potFilename: 'buddyboss-inbox.pot', // Name of the POT file.
