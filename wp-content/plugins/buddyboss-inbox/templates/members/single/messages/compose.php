<form action="<?php bp_messages_form_action('compose' ); ?>" method="post" id="send_message_form" class="standard-form" role="main" enctype="multipart/form-data">
	...
	<label for="send-to-input"><?php _e("Send To (Username or Friend's Name)", 'buddyboss-inbox' ); ?></label>
	...
	<label for="subject"><?php _e( 'Subject', 'buddyboss-inbox' ); ?></label>
	...
	<label for="content"><?php _e( 'Message', 'buddyboss-inbox' ); ?></label>
	...
	<div class="submit">
		<input type="submit" value="<?php esc_attr_e( "Send Message", 'buddyboss-inbox' ); ?>" name="send" id="send" />
	</div>
