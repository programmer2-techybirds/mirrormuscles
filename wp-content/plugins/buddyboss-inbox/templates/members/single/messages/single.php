		...
		<div id="message-recipients">
			<span class="highlight">
				...
				<?php if ( !bp_get_the_thread_recipients() ) : ?>
					...
					<?php _e( 'You are alone in this conversation.', 'buddyboss-inbox' ); ?>

				<?php else : ?>

					<?php printf( __( 'Conversation between %s and you.', 'buddyboss-inbox' ), bp_get_the_thread_recipients() ); ?>

				<?php endif; ?>

			</span>
			
			<a class="button confirm" href="<?php bp_the_thread_delete_link(); ?>" title="<?php esc_attr_e( "Delete Message", "buddypress" ); ?>"><?php _e( 'Delete', 'buddyboss-inbox' ); ?></a>
			
			<?php do_action( 'bbm_message_recipient' ); ?>
			...
			<div class="message-box">
				...
				<div class="message-metadata">
					...
					<div class="avatar-box">
						...
						<strong><?php _e( 'Send a Reply', 'buddyboss-inbox' ); ?></strong>
					</div>
				...
				<div class="message-content">
					...
					<div class="submit">
						<input type="submit" name="send" value="<?php esc_attr_e( 'Send Reply', 'buddyboss-inbox' ); ?>" id="send_reply_button"/>
					</div>
