...
add_filter( 'bboss_licensed_packages', 'bbinbox_register_licensed_package' );
function bbinbox_register_licensed_package( $packages=array() ){
    $this_package = array(
        'id'        => 'bbinbox',
        'name'      => __( 'BuddyBoss Inbox', 'buddyboss-inbox' ),
        'products'  => array(
            ...
            'BBINBOX' => array(
                ...
                'name'          => 'BuddyBoss Inbox',
            ),
        ),
    );
    $packages['bbinbox'] = $this_package;
    return $packages;
}

add_filter( 'bboss_updatable_products', 'bbinbox_register_updatable_product' );
function bbinbox_register_updatable_product( $products ){
    ...
    $products['BBINBOX'] = array(
        ...
        'path'      => 'buddyboss-inbox/buddyboss-inbox.php',
        'id'        => 102,
        'software_ids'  => array( 'BBINBOX_1S', 'BBINBOX_5S', 'BBINBOX_20S' ),
        'type'      => 'plugin',
    );
