...
module.exports = function ( grunt ) {
    ...
    grunt.initConfig( {
        ...
        checktextdomain: {
            options: {
                text_domain: [ 'bb-reply-by-email', 'buddypress', 'bbpress', 'woothemes-sensei', 'wcvendors-pro', 'woocommerce' ], //Specify allowed domain(s)
        ...
        makepot: {
            target: {
                options: {
                    ...
                    potFilename: 'bb-reply-by-email.pot', // Name of the POT file.
