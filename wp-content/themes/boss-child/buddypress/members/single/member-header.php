            ...
            <div class="table-cell">
                <div id="item-header-avatar">
                    <a href="<?php bp_displayed_user_link(); ?>">
			            <?php echo bp_get_displayed_user_avatar(array('type'=>'full','width'=>100,'height'=>100));?>
                    </a>
                </div><!-- #item-header-avatar -->

                <div id="item-header-content">
                    <div class="basic">
                        <h1><?php echo get_fullname(bp_displayed_user_id()); ?></h1><span class="sep"><?php _e( ', ', 'boss' ); ?></span>
