...
if ( function_exists( 'bp_post_get_permalink' ) ) { // ugly ugly ugly hack to check for pre-1.2 versions of BP
	...
	<?php if ( bp_has_groups() ) : while ( bp_groups() ) : bp_the_group(); ?>
			...
			<?php if ( $event != 'create' ) : ?>
				...
				<div class="main-column">
					...
					<p class="bb-search-members-to-invite-title"><?php _e( "Search for members to invite:", 'invite-anyone' ) ?></span></p>
	...
	<?php if ( invite_anyone_access_test() && ! bp_is_group_create() ) : ?>
		<p class="send-invitations-by-email-wrap clearfix"><?php _e( 'Want to invite someone to the group who is not yet a member of the site?', 'invite-anyone' ) ?> <a class="button send-invitations-by-email alignright" href="<?php echo bp_loggedin_user_domain() . BP_INVITE_ANYONE_SLUG . '/invite-new-members/group-invites/' . bp_get_group_id() ?>"><?php _e( 'Send invitations by email', 'invite-anyone' ) ?></a></p>
	<?php endif; ?>
	...
	<?php if ( ! bp_get_new_group_id() ) : ?>
		...
		<div class="left-menu">
			...
			<?php if ( ! invite_anyone_is_large_network( 'users' ) ) : ?>
				...
				<div id="invite-anyone-member-list">
					<ul>
						<?php bp_new_group_invite_member_list_() ?>
					</ul>
				</div>
			<?php endif ?>
		</div>
		...
		<div class="main-column">
			...
			<p class="bb-search-members-to-invite-title"><?php _e( "Search for members to invite:", 'invite-anyone' ) ?></p>
				...
				<?php if ( bp_group_has_invites() ) : ?>
					...
					<?php while ( bp_group_invites() ) : bp_group_the_invite(); ?>
						...
						<li id="<?php bp_group_invite_item_id() ?>">
							...
							<h4><a class="fullname" href="<?php echo bp_core_get_user_domain($invites_template->invite->user->ID);?>"><?php echo get_fullname($invites_template->invite->user->ID);?></a></h4>
							<span class="activity"><?php bp_group_invite_user_last_active() ?></span>
