...
<div id="buddypress">
    ...
    <!--<header class="activity-header page-header">-->
        ...
        <h2 class="entry-title main-title">Notifications</h2>
    </header><!-- .page-header -->
			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<?php if ( bp_is_active( 'friends' ) ) : ?>
					...
					<?php if ( bp_get_total_friend_count( bp_loggedin_user_id() ) ) : ?>
						...
						<li class="selected" id="activity-friends"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/' . bp_get_friends_slug() . '/'; ?>" title="<?php esc_attr_e( 'The activity of my friends only.', 'boss' ); ?>"><?php printf( __( 'My Friends <span>%s</span>', 'boss' ), bp_get_total_friend_count( bp_loggedin_user_id() ) ); ?></a></li>
