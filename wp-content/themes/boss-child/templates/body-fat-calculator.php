		            ...
		            <div class="col-md-12 bfc-left">
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="col-md-6 input-group"  style="padding: 0;" >
		                        <select <?php disabled($member_type, 'standard'); disabled($member_type, 'pt');?> name="gender" id="gender" class="form-control" required>
		                ...
		                <div class="form-group">
		                    ...
		                    <div class="col-md-6 input-group">
		                        <input type="number"  min="8" class="form-control" name="age" id="age" placeholder="Age" value="<?php echo $age;?>" <?php disabled($member_type, 'standard'); disabled($member_type, 'pt');?> required >
