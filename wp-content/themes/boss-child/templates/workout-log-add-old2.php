...
<div id="add-wl-container">
    <form name="add-wl-form" id="add-wl-form" class="select-exercise-container wl-form" action="<?php echo WP_PLUGIN_URL."/mirror-muscles/handler.php";?>" method="post" enctype="multipart/form-data">
