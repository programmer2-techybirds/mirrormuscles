...
<div id="add-wl-container">
    ...
    <form name="add-awl-form" id="add-awl-form" class="select-exercise-container wl-form" action="https://staging-uat.mirrormuscles.org/wp-content/plugins/mirror-muscles/handler.php" method="post" enctype="multipart/form-data">
