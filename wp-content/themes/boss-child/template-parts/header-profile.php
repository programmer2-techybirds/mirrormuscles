	...
	<div class="<?php echo ($rtl) ? 'left-col-inner' : 'right-col-inner'; ?>">
			...
			<?php if ( buddyboss_is_bp_active() ) { ?>
				...
				<div class="header-account-login">
					...
					<a class="user-link" href="<?php echo bp_core_get_user_domain( get_current_user_id() ); ?>">
						<span class="name"><?php echo get_fullname(get_current_user_id()); ?></span>
						<span><?php echo bp_core_fetch_avatar( array( 'item_id' => get_current_user_id(), 'type' => 'full', 'width' => '100', 'height' => '100' ) ); ?>                        </span>
					</a>
		...
		<?php } else { ?>
			...
			<?php if ( !is_user_logged_in() && buddyboss_is_bp_active() && !bp_hide_loggedout_adminbar( false ) ) : ?>
						<!--<a class="mymenu" href="<?php echo get_field('about_link','option'); ?>">About</a>
						<a class="mymenu" href="<?php echo get_field('services_link','option'); ?>">Services</a>
						<a class="mymenu" href="<?php echo get_field('testimonials_link','option'); ?>">Testimonials</a>-->
